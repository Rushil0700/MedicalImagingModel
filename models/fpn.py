...
Lateral 1x1 convs project each backbone stage to a common channel width, a
top-down pathway fuses coarse semantic context into finer levels, and a 3x3
smoothing conv removes upsampling aliasing at each fused level.
"""
